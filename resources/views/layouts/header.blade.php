...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title> PWM Admin Dashboard</title>
	{{-- icon fonts link --}}
    <link rel="stylesheet" href="{{URL::asset('icons/icofont.min.css')}}">
	<!-- FAVICONS ICON -->
	{{-- <link rel="/shortcut icon" type="image/png" href="/images/favicon.png"> --}}
	<link href="/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
	<link href="/vendor/owl-carousel/owl.carou	sel.css" rel="stylesheet">
		...
		<div class="nav-header">
            <a href="" class="brand-logo">
				...
				<div class="brand-title">
					<h2 class="{{route('dashboard')}}">PWM</h2>
					{{-- <br> --}}
					<span class="brand-sub-title"> 
						{{-- <img src="/uploads/user/{{ auth()->user()->photo}}"
						 alt="" height="40px" width="40px" style="border-radius: 50%"> --}}
						{{auth()->user()->name}}</span>
				</div>
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
							<div class="dashboard_bar">
                              <a href="{{route('dashboard')}}"> PWM Dashboard</a>
                            </div>
                        </div>
                        <ul class="navbar-nav header-right">
							<li class="nav-item d-flex align-items-center">
								{!! Form::open(array('url' => '/search/result' , 'method' => 'POST' , 'enctype'=>'multipart/form-data')) !!}
						 ...
						 alt="" height="40px" width="40px" style="border-radius: 50%">
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									{{Form::open(['url'=>'logout','class'=>'dropdown-item ai-icon'])}}
